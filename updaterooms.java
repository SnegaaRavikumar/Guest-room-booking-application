...
/**
 * Servlet implementation class updaterooms
 */
...
public class updaterooms extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int new1=Integer.parseInt(request.getParameter("new")); 
		 ...
		 int rs=stmt.executeUpdate("Update addrooms set maximum='"+new1+"' where roomno='"+rno+"'");  
		 out.println("<html>");
		 out.println("<head>");
		 out.println("<style>");
		 out.println(".border1{");
        ...
        out.println("<br><br>");
        out.println("<h3>The respective room is updated");
